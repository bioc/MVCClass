...
created new instances of the MVC that were linked to the parent that 
spawned them. 
...
XLisp-Stat \cite{Lisp}, iPlots \cite{iPlots}, and
...
be linked to any one of a variety of other MVCs.  In our design, each 
MVC will contain one model and thus, linked models also indicate linked 
MVCs.
...
found in the \Rpackage{MVCClass} and \Rpackage{iSNetwork} Vignettes.
